...
_FORCED_COT = re.compile(
    ...
    r"think step by step|step[- ]by[- ]step|let'?s think|chain of thought|рассуждай вслух)"
)
...
_TRIVIAL_WEAK = re.compile(r"(подправь|поправь мелк|измени строк|добавь лог|add a log)", re.I)
