...
[![тесты](https://img.shields.io/badge/tests-2436-2ea043)](tests)
[![API-ключи](https://img.shields.io/badge/API%20keys-none-1f6feb)](#почему-это-работает-на-вашей-подписке)

Claude Code · Codex · 2436 теста · ноль зависимостей · ноль API-ключей · работает офлайн
...
```
воспроизводимость: nativeprompt 0.6.1 · правила claude 2026-09-02 · доки
...
Проверяемость: `python -m pytest -q` дает 2436 теста (детект, детекторы, перепись, харнесс,
