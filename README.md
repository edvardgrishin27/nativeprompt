...
![281 tests](https://img.shields.io/badge/tests-837%20passing-brightgreen)
...
```bash
python3 -m pytest -q          # 837 tests: detection, detectors, rewrite, harness, rules integrity, frozen snapshot
```
