...
```bash
# 1. Test suite — 807 tests, no dependencies beyond pytest
cd nativeprompt && python3 -m pytest -q
# 807 passed
#   592 invariant · 72 regressions · 62 rule integrity · 32 detection · 23 capabilities · 9 analysis · 8 rewrite · 6 harness · 3 update
