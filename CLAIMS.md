...
```bash
# 1. Test suite — 844 tests, no dependencies beyond pytest
cd nativeprompt && python3 -m pytest -q
# 844 passed
#   628 invariant · 73 regressions · 62 rule integrity · 32 detection · 23 capabilities · 9 analysis · 8 rewrite · 6 harness · 3 update
